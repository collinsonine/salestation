...
class SettingTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        Customer::Create([
            ...
            'email' => 'customer@salestation.com',
            'phone' => '123456789',
            'country' => 'Nigeria',
            'city' => 'Abuja',
            'address' => 'Abuja',
        ...
        Warehouse::create([
            ...
            'country' => 'Nigeria',
            'city' => 'Abuja',
            'email' => 'warehouse1@salestation.com',
            'zip_code' => '12345',
        ]);
        ...
        if (! keyExist('email')) {
            Setting::create(['key' => 'email', 'value' => 'support@salestation.com']);
        }

        if (! keyExist('company_name')) {
            Setting::create(['key' => 'company_name', 'value' => 'Salestation-pos']);
        }
        ...
        if (! keyExist('developed')) {
            Setting::create(['key' => 'developed', 'value' => 'collinsonine']);
        }

        if (! keyExist('footer')) {
            Setting::create([
                'key' => 'footer', 'value' => '2024 All rights reserved - v1.1.0',
            ]);
        }
        ...
        if (! keyExist('address')) {
            Setting::create([
                'key' => 'address', 'value' => 'Abuja, Nigeria.',
            ]);
        }
